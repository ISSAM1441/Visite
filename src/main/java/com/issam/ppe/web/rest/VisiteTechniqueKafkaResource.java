...
import com.issam.ppe.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/visite-technique-kafka")
public class VisiteTechniqueKafkaResource {

    private final Logger log = LoggerFactory.getLogger(VisiteTechniqueKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public VisiteTechniqueKafkaResource(KafkaProperties kafkaProperties) {
